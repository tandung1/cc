module.exports.config = {
	...
	} else s.sendMessage("[⚜️]➜ 𝐁𝐨𝐭 𝐜𝐚̂̀𝐧 𝐪𝐮𝐚̉𝐧 𝐭𝐫𝐢̣ 𝐯𝐢𝐞̂𝐧 𝐤𝐡𝐢 𝐩𝐡𝐞̂ 𝐝𝐮𝐲𝐞̣̂𝐭, 𝐯𝐮𝐢 𝐥𝐨̀𝐧𝐠 𝐜𝐚̂́𝐩 𝐪𝐮𝐲𝐞̂̀𝐧 𝐪𝐮𝐚̉𝐧 𝐭𝐫𝐢̣ 𝐯𝐢𝐞̂𝐧 𝐯𝐚̀ 𝐭𝐡𝐮̛̉ 𝐥𝐚̣𝐢 👾", a.threadID)
	...
	if ("reply" === n.type) {
		...
		e.addUserToGroup(a, o), e.sendMessage(`[⚜️]➜ 𝐓𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 𝐝𝐮𝐲𝐞̣̂𝐭 𝐜𝐨𝐧 𝐯𝐨̛̣ 𝐧𝐚̀𝐲 𝐯𝐚̀𝐨 𝐧𝐡𝐨́𝐦 ❤️`, o, (() => e.unsendMessage(n.messageID)))
	}
};