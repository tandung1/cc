module.exports.config = {
    ...
    case "unbanthread":
        ...
        n.sendMessage(`[⚜️]→ Thông báo từ Admin ${l} ←[⚜️]\n\n[⚜️]→ Nhóm ${c} của bạn đã được Gỡ Ban\n\n[⚜️]→ Có thể sử dụng được bot ngay bây giờ`, o, (() => n.sendMessage(`${global.data.botID}`, (() => n.sendMessage(`=== 『 Thực thi Unban 』 ===\n\n${i}`, t.threadID, (() => n.unsendMessage(s.messageID)))))));
        break;
    case "unbanuser":
    ...
    case "-t": {
        ...
        }), r) : "[⚜️]→ Hiện tại không có nhóm nào bị ban!", d, r)
    }
    case "user":
    case "u":
    case "-u": {
        ...
        return e.sendMessage(0 != h.length ? e.sendMessage(`[❎]→ Hiện tại đang có ${h.length} người dùng bị ban\n\n${h.join("\n")}\n\n[⚜️]→ Reply tin nhắn này + số thứ tự, có thể rep nhiều số, cách nhau bằng dấu cách để unban user tương ứng`, d, ((e, a) => {
        ...
        }), r) : "[⚜️]→ Hiện tại không có người dùng bị ban", d, r)
    }
    default:
