...
module.exports.run = async function ({ api, event, args, Users, Threads }) {
  ...
  if (thu == 'Saturday') thu = 'Thứ Bảy'
    ...
    if (query == 'all' || query == '-a') {
        header = '[⚜️]=== 『 CHECK - ALL 』 ===[⚜️]\n◆━━━━━━━━━━━━━━━━◆\n\n';
        data = threadData.total;
    } else if (query == 'week' || query == '-w') {
        header = '[⚜️]=== 『 CHECK - WEEK 』 ===[⚜️]\n◆━━━━━━━━━━━━━━━━◆\n\n';
        data = threadData.week;
    } else if (query == 'day' || query == '-d') {
        header = '[⚜️]=== 『 CHECK - DAY 』 ===[⚜️]\n◆━━━━━━━━━━━━━━━━◆\n\n';
        data = threadData.day;
    } else {
        data = threadData.total;
    }
...
permission = `Người Hỗ Trợ`; else if (threadInfo.adminIDs.some(i => i.id == UID)) permission = `Quản Trị Viên`; else permission = `Thành Viên`;
        ...
        ━━━━━━━━━━━━━━━━━━
        [⚜️]➜ Tin Nhắn Trong Ngày: ${userTotalDay}
        [⚜️]➜ Hạng Trong Ngày: ${userRankDay + 1}
        ━━━━━━━━━━━━━━━━━━
        [⚜️]➜ Tin Nhắn Trong Tuần: ${userTotalWeek}
        [⚜️]➜ Hạng Trong Tuần: ${userRankWeek + 1}
        ━━━━━━━━━━━━━━━━━━
        [⚜️]➜ Tổng Tin Nhắn: ${userTotal}
        [⚜️]➜ Hạng Tổng: ${userRank + 1}
        ━━━━━━━━━━━━━━━━━━
        [⚜️]➜ Hôm Nay Là: ${thu}
        [⚜️]➜ Thời Gian Kiểm Tra: ${time}
        `.replace(/^ +/gm, '');
    } else {
        body = storage.map(item => {
            return `${count++}. ${item.name} với ${item.count} tin nhắn`;
        }).join('\n');
        footer = `[⚜️]➜ Tổng Tin Nhắn: ${storage.reduce((a, b) => a + b.count, 0)}`;
    }
